...
public class TeamPlanningTestPage extends Testdata {
	...
	public void isTeamplanningButtonclicked() {
		...
		Assert.assertEquals(teamplanningTab.clickTeamplanningButton().equalsIgnoreCase("Team Planning"), true);
	}
	...
	*/
	...
	public void isAddNewbuttonClicked() {
		...
		Assert.assertEquals(teamplanningTab.isAddnewButtonClicked().equalsIgnoreCase("New"),true);
	}
	...
	public void isAddwithDetailsButtonclicked() {
		...
		String textSeen = teamplanningTab.addNewtext();
		Assert.assertEquals(textSeen, "New");
	}
}
